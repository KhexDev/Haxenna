...
HXLINE(  10)		this->fps = 60;
HXLINE(  14)		super::__construct();
HXLINE(  15)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,1280,720,::hx::ClassOf< ::SongSelection >(),1,this->fps,this->fps,null(),null()));
HXLINE(  16)		this->addChild( ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,10,-1));
            	}
...
static ::hx::StorageInfo Main_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(Main_obj,fps),HX_("fps",e9,c7,4d,00)},
	{ ::hx::fsUnknown, 0, null()}
};
