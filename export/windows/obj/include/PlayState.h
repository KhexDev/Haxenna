...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		int good;
		int bads;
		 ::flixel::FlxSprite shitSprite;
		 ::flixel::ui::FlxBar lifeBar;
		int health;
		::Array< bool > noteBool;
		Float holdTimer;
		 ::flixel::text::FlxText accuracyText;
		...
		::Array< bool > keys;
		void handInput( ::openfl::events::KeyboardEvent event);
		::Dynamic handInput_dyn();

		void realeasedInput( ::openfl::events::KeyboardEvent event);
		::Dynamic realeasedInput_dyn();

		void addAccuracyText(::String text);
		::Dynamic addAccuracyText_dyn();
